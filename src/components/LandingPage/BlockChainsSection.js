...
function BlockChainsSection() {
  return (
    <div className="max-w-screen-xl mx-auto px-6 h-screen flex flex-col justify-center mt-12">
      <p className="font-bold text-center text-3xl xl:text-5xl leading-snug">Over 5 Blockchains</p>
      <p className="font-bold text-center text-3xl xl:text-5xl leading-snug">supported and many more on the way</p>
